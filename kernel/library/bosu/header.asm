...
LIBRARY_BOSU_WINDOW_FLAG_flush			equ	1 << 0
LIBRARY_BOSU_WINDOW_FLAG_visible		equ	1 << 1
LIBRARY_BOSU_WINDOW_FLAG_fixed_xy		equ	1 << 2
LIBRARY_BOSU_WINDOW_FLAG_fixed_z		equ	1 << 3
LIBRARY_BOSU_WINDOW_FLAG_fragile		equ	1 << 4
LIBRARY_BOSU_WINDOW_FLAG_arbiter		equ	1 << 6
LIBRARY_BOSU_WINDOW_FLAG_transparent		equ	1 << 8
LIBRARY_BOSU_WINDOW_FLAG_reserved		equ	1 << 9
LIBRARY_BOSU_WINDOW_FLAG_unregistered		equ	1 << 10
LIBRARY_BOSU_WINDOW_FLAG_header			equ	1 << 11
LIBRARY_BOSU_WINDOW_FLAG_border			equ	1 << 12
LIBRARY_BOSU_WINDOW_FLAG_BUTTON_close		equ	1 << 13
LIBRARY_BOSU_WINDOW_FLAG_BUTTON_min		equ	1 << 14
